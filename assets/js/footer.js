(function () {
    ...
    // ─── FOOTER MOBILE (layout próprio para celular) ──────────────────────
    const mobileHTML = `
    <footer class="invlab-footer-mobile" style="background: rgba(13,13,13,0.97); border-top: 1px solid rgba(212,175,55,0.2); margin-top: 60px; padding: 32px 16px 20px;">
        ...
        <!-- Cabeçalho INVLAB — acima das colunas -->
        <div style="text-align:center; margin-bottom:28px; padding-bottom:20px; border-bottom:1px solid rgba(212,175,55,0.15);">
            <a href="${r}pages/guia_invlab.html" style="display:inline-block; color:#D4AF37; font-size:1rem; font-weight:700; text-decoration:none; margin-bottom:10px;">🧭 Guia do INVLAB →</a>
            <p style="font-size:0.8rem; line-height:1.6; color:#94A3B8; margin:0; padding:0 8px;">Laboratório educacional de investimentos. Sem venda de produtos, sem comissões, sem viés comercial.</p>
        </div>
        ...
        <div style="border-top:1px solid rgba(212,175,55,0.1);padding-top:16px;">
            <p style="font-size:0.72rem;color:#64748B;text-align:center;line-height:1.6;margin-bottom:8px;">
                ⚠️ Conteúdo 100% educacional e autoral. Não somos corretora, não vendemos produtos, não recebemos comissões.
            </p>
